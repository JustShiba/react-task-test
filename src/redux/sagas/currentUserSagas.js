...
/**
 * Остановился на добавлении саг к экшенам
 * Задачи: 
 *  1. Поменять экшен в местах вызова на selectUserId__START, где нужен только айдишник
 *  2. Дописать сагу к первому пункту
 *  3. Добавить экшены в местах, где нужны данные о пользователях (getDataCurrentUser__START)
 *  4. Проверить на совместимость с сагой вотчером
 *  5. Следить за тем, что передаю в виспатче в экшен
 */